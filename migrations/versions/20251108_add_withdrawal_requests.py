...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('entry_fee_type', postgresql.ENUM('stars', 'rub', name='currencytype', create_type=False), nullable=False),
        sa.Column('entry_fee_amount', sa.Float(), nullable=False),
        sa.Column('status', postgresql.ENUM('pending', 'active', 'finished', 'cancelled', name='rafflestatus', create_type=False), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('type', postgresql.ENUM('deposit', 'withdrawal', 'raffle_entry', 'raffle_win', 'refund', name='transactiontype', create_type=False), nullable=False),
        sa.Column('amount', sa.Float(), nullable=False),
        sa.Column('currency', postgresql.ENUM('stars', 'rub', name='currencytype', create_type=False), nullable=False),
        sa.Column('status', postgresql.ENUM('pending', 'completed', 'failed', 'cancelled', name='transactionstatus', create_type=False), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('amount', sa.Float(), nullable=False),
        sa.Column('currency', postgresql.ENUM('stars', 'rub', name='currencytype', create_type=False), nullable=False),
        sa.Column('status', postgresql.ENUM('pending', 'approved', 'rejected', 'processing', 'completed', 'failed', name='withdrawalstatus', create_type=False), nullable=True),
    ...
    op.create_index(op.f('ix_withdrawal_requests_id'), 'withdrawal_requests', ['id'], unique=False, if_not_exists=True)
